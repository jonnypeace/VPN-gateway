...
ip a
~~~
Replace "HOSTNAMEorIPofGATEWAY" with the IP above (the above ip is for home use, if you're using a VPS, it will be the hostname or public ip you use to SSH into the server, BUT i'm not covering VPS/cloud in this readme)
~~~
